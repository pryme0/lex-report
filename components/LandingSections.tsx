  ...
  return (
    <section className="lx-search-section" aria-labelledby="search-preview-title">
      <div className="lx-section-heading lx-section-heading-center">
        ...
        <p>Use ordinary language or precise legal fields. Electronic Lextech Report returns structured authorities, not isolated keyword hits.</p>
      </div>
    ...
    <section className="lx-anatomy-section" id="platform" aria-labelledby="anatomy-title">
      <div className="lx-anatomy-wrap">
        <div className="lx-report-sheet" aria-label="Example structured law report">
          <div className="lx-report-masthead"><span>Electronic Lextech Report</span><span>Supreme Court · 2026</span></div>
  ...
  return (
    <section className="lx-product-section" aria-labelledby="product-title">
      ...
      <div className="lx-product-window">
        <div className="lx-window-top"><span /><span /><span /><strong>Electronic Lextech Report / {tab.toLowerCase()}</strong></div>
        <div className="lx-window-body">
          <aside><div className="lx-window-logo">ELR</div>{[Search, FileText, Network, BriefcaseBusiness, BookOpen].map((Icon, i) => <Icon key={i} size={16} className={i === (tab === "Research" ? 0 : tab === "Matters" ? 3 : 1) ? "active" : ""} />)}</aside>
          <main>
...
function EditorialStandards() {
  return (
    <section className="lx-standards-section" id="standards" aria-labelledby="standards-title">
      <div className="lx-standard-seal" aria-hidden="true"><span>ELR</span><strong>Verified</strong><small>Editorial standard</small></div>
      <div className="lx-standards-copy">
        <div className="lx-section-heading">
          <p className="l-hero-eyebrow">The Electronic Lextech Report editorial standard</p>
...
export function LandingFinalCta({ signedIn = false }: { signedIn?: boolean }) {
  return (
    <section className="lx-final-cta">
      ...
      <p>Electronic Lextech Report · Nigerian legal intelligence</p>
