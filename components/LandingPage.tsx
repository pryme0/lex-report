        ...
        <div className="l-caps-inner">
          ...
          <div className="l-caps-grid">
            {[
              ...
              { num: "03", title: "Matter-ready bundles", desc: "Save cases into client matters, build argument outlines from verified authorities, and export formatted research bundles ready for brief or court." },
            ].map(({ num, title, desc }) => (
